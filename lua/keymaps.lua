...
vim.keymap.set('n', '<M-,>', '<c-w>5<', { desc = 'Window Decrease Width', silent = true })
vim.keymap.set('n', '<M-.>', '<c-w>5>', { desc = 'Window Increase Width', silent = true })
vim.keymap.set('n', '<M-/>', '<C-W>-', { desc = 'Window Decrease Height', silent = true })
vim.keymap.set('n', '<M-;>', '<C-W>+', { desc = 'Window Increase Height', silent = true })
